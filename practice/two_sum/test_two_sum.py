"""Tests for Two Sum — your attempt (solution.py) against both case sets.

cases.json (marker `simple`) is the "Run" set; cases_full.json (marker `full`) is
the "Submit" gauntlet. The worked approaches live in ../../docs/problems/two_sum.md.
"""
...
def _check(method, case):
    # Two Sum accepts any order, so compare the index pair order-insensitively.
