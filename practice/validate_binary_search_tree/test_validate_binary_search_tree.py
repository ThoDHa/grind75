"""Tests for Validate Binary Search Tree — your attempt (solution.py) against both sets.
...
../../docs/problems/validate_binary_search_tree.md.
"""
...
def test_solution_simple(case):
    try:
        _check(solution.Solution().isValidBST, case)
    except NotSolved:
