"""Tests for Maximum Depth of Binary Tree — your attempt (solution.py) against both sets.
...
../../docs/problems/maximum_depth_of_binary_tree.md.
"""
...
def test_solution_simple(case):
    try:
        _check(solution.Solution().maxDepth, case)
    except NotSolved:
