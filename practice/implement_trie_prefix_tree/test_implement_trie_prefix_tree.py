...
`expected` results. `run_operations` drives the Trie class and the results are
compared against `expected`. The worked approaches live in
../../docs/problems/implement_trie_prefix_tree.md.
"""
