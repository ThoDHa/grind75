"""Tests for Binary Tree Maximum Path Sum — your attempt (solution.py) against both sets.
...
../../docs/problems/binary_tree_maximum_path_sum.md.
"""
...
def _check(method, case):
    ...
    assert method(root) == case["expected"]
...
def test_solution_simple(case):
    try:
        _check(solution.Solution().maxPathSum, case)
    except NotSolved:
