...
def _check(method, case):
    # Many approaches sink land in-place, so hand each call its own grid copy.
...
def test_solution_simple(case):
    try:
        _check(solution.Solution().numIslands, case)
    except NotSolved:
