...
../../docs/problems/letter_combinations_of_a_phone_number.md.
"""
...
def _check(method, case):
    # Combinations may be returned in any order, so compare order-insensitively.
...
def test_solution_simple(case):
    try:
        _check(solution.Solution().letterCombinations, case)
    except NotSolved:
